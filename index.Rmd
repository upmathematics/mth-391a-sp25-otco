...
|  | W 2/5 | _Cancelled_ |
|  | F 2/7 |Data Wrangling on Multiple Tables |
| **5** | M 2/10 | Basics of Visualizations & <br>**Project Phase 2** |
|  | W 2/12 | Transforming Tables for Visualizations |
|  | F 2/14 | _Cancelled_ |
| **6** | M 2/17 | **Project Milestone: 1st Progress Report & <br>Project Phase 3** |
|  | W 2/19 | Iteration and Conditional Statements <br>_Asynchronous_ |
|  | F 2/21 | Functions <br>_Asynchronous_ |
| **7** | M 2/24 | Wrangling High-Dimensional Data & <br>**Project Phase 4** |
|  | W 2/26 | Scaling and Coloring |
|  | F 2/28 | _Cancelled_ |
| **8** | M 3/3 | _Spring Vacation_ |
|  | W 3/5 | _Spring Vacation_ |
|  | F 3/7 | _Spring Vacation_ |
| **9** | M 3/10 | Visualizing High-Dimensional Data, <br>Advanced Visualizations & <br>**Project Phase 5** |
...
|  | F 3/21 | Visualizing and Analyzing Spatial Data |
...
*Amendment 10: The title was changed from "Appointment Cancelation Policies" to "Appointment Cancellation Policy".*
...
| [Reshaping One Table](lessons/3.3-mth391-reshaping-one-table/3.3-mth391-reshaping-one-table.html) | Ch. 5 @wickham2023r |
| [Project Milestone: Project Proposal](lessons/4.1-mth391-project-milestone-project-proposal/4.1-mth391-project-milestone-project-proposal.html) | - |
| [Data Wrangling on Multiple Tables](lessons/4.2-mth391-data-wrangling-on-multiple-tables/4.2-mth391-data-wrangling-on-multiple-tables.html) | Ch. 5 @baumer2017modern & Ch. 7 @wickham2023r |
| [Basics of Visualizations](lessons/5.1-mth391-basics-of-visualizations/5.1-mth391-basics-of-visualizations.html) | Ch. 1 @wickham2023r & Ch. 2 @baumer2017modern |
| [Transforming Tables for Visualizations](lessons/5.2-mth391-transforming-tables-for-visualization/5.2-mth391-transforming-tables-for-visualization.html) | - |
| [Project Milestone: 1st Progress Report](lessons/6.1-mth391-project-milestone-1st-progress-report/6.1-mth391-project-milestone-1st-progress-report.html) | - |
| Iteration and Conditional Statements | [Pyflo](https://pyflo.net/){target="_blank"}: Guided Projects 1 and 2 |
| Functions | [Pyflo](https://pyflo.net/){target="_blank"}: Guided Projects 3 and 4 |
| Wrangling High-Dimensional Data | Ch. 3.1 - 3.3 @vanderplas2016python |
| Scaling and Coloring | - |
| [Visualizing High-Dimensional Data & Advanced Visualizations](lessons/9.1-mth391-visualizing-high-dimensional-data-and-advanced-visualizations/9.1-mth391-visualizing-high-dimensional-data-and-advanced-visualizations.html) | - |
| [Wrangling Temporal Data](lessons/9.2-mth391-wrangling-temporal-data/9.2-mth391-wrangling-temporal-data.html) | Ch. 17 @wickham2023r |
| [Visualizing and Analyzing Temporal Data](lessons/9.3-mth391-visualizing-and-analyzing-temporal-data/9.3-mth391-visualizing-and-analyzing-temporal-data.html) | - |
| [Project Milestone: 2nd Progress Report](lessons/10.1-mth391-project-milestone-2nd-project-report/10.1-mth391-project-milestone-2nd-project-report.html) | - |
| Wrangling Spatial Data | TBA |
| Visualizing and Analyzing Spatial Data | TBA |
...
| Project Milestone: Final Report | - |
