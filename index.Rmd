...
|  | W 1/15 | [Data Science Life Cycle](lessons/1.2-mth391-data-science-life-cycle/1.2-mth391-data-science-life-cycle.html) | - |
|  | F 1/17 | Cloud Computing | - |
| **2** | M 1/20 | _MLK Day (no classes, offices closed)_ | - |
|  | W 1/22 | Reproducible Workflows | TBA |
|  | F 1/24 | Basics of Data Wrangling | TBA |
| **3** | M 1/27 | Project Proposal & <br>**Project Phase 1** | - |
|  | W 1/29 | Data Wrangling on One Table | TBA |
|  | F 1/31 | Data Wrangling on Multiple Tables | TBA |
| **4** | M 2/3 | **Project Phase 2** | - |
|  | W 2/5 | Data Reshaping | TBA |
|  | F 2/7 | Basics of Visualizations | TBA |
| **5** | M 2/10 | **Project Phase 3** | - |
|  | W 2/12 | Transforming Tables for Visualizations | TBA |
|  | F 2/14 | Advanced Visualizations | TBA |
| **6** | M 2/17 | 1st Progress Report & <br>**Project Phase 4** | - |
|  | W 2/19 | Iteration | TBA |
|  | F 2/21 | Wrangling High-Dimensional Data | TBA |
| **7** | M 2/24 | **Project Phase 5** | - |
|  | W 2/26 | Scaling and Coloring | TBA |
|  | F 2/28 | Visualizing High-Dimensional Data | TBA |
| **8** | M 3/3 | _Spring Vacation_ | - |
|  | W 3/5 | _Spring Vacation_ | - |
|  | F 3/7 | _Spring Vacation_ | - |
| **9** | M 3/10 | **Project Phase 6** | - |
|  | W 3/12 | TBA | TBA |
|  | F 3/14 | TBA | TBA |
| **10** | M 3/17 | 2nd Progress Report & <br>**Project Phase 7** | - |
|  | W 3/19 | TBA | TBA |
|  | F 3/21 | TBA | TBA |
| **11** | M 3/24 | **Project Phase 8** | - |
|  | W 3/26 | TBA | TBA |
|  | F 3/28 | TBA | TBA |
| **12** | M 3/31 | **Project Phase 9** | - |
|  | W 4/2 | TBA | TBA |
|  | F 4/4 | TBA | TBA |
| **13** | M 4/7 | Final Report & <br>**Project Phase 10** | - |
|  | W 4/9 | TBA | TBA |
|  | F 4/11 | TBA | TBA |
| **14** | M 4/14 | **Project Phase 11** | - |
|  | W 4/16 | TBA | - |
