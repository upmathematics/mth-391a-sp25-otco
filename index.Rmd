...
|  | W 1/29 | Data Wrangling on One Table |
|  | F 1/31 | Data Wrangling on Multiple Tables |
| **4** | M 2/3 | Using R for Data Wrangling & **Project Milestone: Project Proposal & <br>Project Phase 1** |
|  | W 2/5 | Data Reshaping |
...
| [Data Wrangling on One Table (Part I)](lessons/3.2-mth391-data-wrangling-on-one-table-part-i/3.2-mth391-data-wrangling-on-one-table-part-i.html) | Ch. 4 @baumer2017modern |
| Data Wrangling on Multiple Tables | Ch. 5 @baumer2017modern |
| Using R for Data Wrangling | TBA |
| Data Reshaping | TBA |
